					...
					<ul class="cmsMnuParent">
						<li class="cmsWidgetCogIcon"><a class="cmsWidgetBarLink cmsWidgetBarIconCog" id="cmsWidgetBarIcon" href="javascript:void(0);">Modify</a>
							<ul class="cmsMnuChildren">
								...
								<li runat="server" id="liHistory"><a class="cmsWidgetBarLink cmsWidgetBarIconWidget2" id="cmsContentHistoryLink" href="javascript:cmsManageWidgetHistory('{WIDGET_KEY}')">
									History </a></li>
								<li runat="server" id="liRemove"><a class="cmsWidgetBarLink cmsWidgetBarIconCross" id="cmsContentEditLink" href="javascript:cmsRemoveWidgetLink('{WIDGET_KEY}');">
									Remove </a></li>
							</ul>
						</li>
					</ul>
