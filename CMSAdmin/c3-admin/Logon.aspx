<%@ Page Async="true" Title="Logon" Language="C#" MasterPageFile="MasterPages/Public.Master" AutoEventWireup="true" CodeBehind="Logon.aspx.cs" Inherits="Carrotware.CMS.UI.Admin.c3_admin.Logon" %>

<%@ Import Namespace="Carrotware.CMS.Core" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
	<asp:Panel ID="panelLogin" runat="server" DefaultButton="cmdLogon">
			...
			<table style="width: 300px;">
				<tr>
					...
					<td>&nbsp;<b class="caption">username</b>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="validationError" ForeColor="" ControlToValidate="txtUserName"
							ErrorMessage="!" ToolTip="Username is required" ValidationGroup="loginTemplate" Display="Dynamic" Text="**" />
						<br />
						<asp:TextBox ID="txtUserName" runat="server" Width="180px" MaxLength="60" ValidationGroup="loginTemplate" TabIndex="1" />
					</td>
					<td rowspan="2">
				...
				<tr>
					...
					<td>
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="validationError" ForeColor="" ControlToValidate="txtPassword"
							ErrorMessage="!" ToolTip="Password is required" ValidationGroup="loginTemplate" Display="Dynamic" Text="**" />
						<br />
						<asp:TextBox ID="txtPassword" runat="server" TextMode="Password" Width="180px" MaxLength="60" ValidationGroup="loginTemplate" TabIndex="2" />
					</td>
				</tr>
				<tr>
					<td>
