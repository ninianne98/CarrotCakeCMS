	...
	<asp:PlaceHolder ID="phStep1" runat="server">
		...
		<table style="width: 400px;">
			<tr>
				...
				<td style="width: 210px;">
					<asp:TextBox Style="width: 200px;" ValidationGroup="createWizard" ID="UserName" runat="server" TabIndex="1" />
			...
			<tr>
				...
				<td>
					<asp:TextBox Style="width: 200px;" ValidationGroup="createWizard" ID="Password" runat="server" TextMode="Password" TabIndex="2" />
			...
			<tr>
				...
				<td>
					<asp:TextBox Style="width: 200px;" ValidationGroup="createWizard" ID="ConfirmPassword" runat="server" TextMode="Password" TabIndex="3" />
		...
		<table>
			<tr>
				...
				<td>
					<asp:Button ID="btnStepNextButton" runat="server" OnClick="btnStepNextButton_Click" Text="Create User" CommandName="MoveNext" ValidationGroup="createWizard" TabIndex="5" />
				</td>
				<td>&nbsp;
				</td>
				<td>
