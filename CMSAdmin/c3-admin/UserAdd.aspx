		...
		<asp:PlaceHolder ID="phStep1" runat="server">
			...
			<table style="width: 300px;">
				<tr>
					...
					<td>
						<asp:Button ID="btnStepNextButton" runat="server" OnClick="btnStepNextButton_Click" Text="Create User" CommandName="MoveNext" ValidationGroup="createWizard" TabIndex="5" OnClientClick="return ClickApplyBtn()" />
					</td>
					<td>&nbsp;
					</td>
					<td>
