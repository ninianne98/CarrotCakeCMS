<%@ Page Title="CategoryIndex" Language="C#" MasterPageFile="~/Manage/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="CategoryIndex.aspx.cs"
	Inherits="Carrotware.CMS.UI.Admin.Manage.CategoryIndex" %>
	...
	<div id="SortableGrid">
		<carrot:CarrotGridView CssClass="datatable" DefaultSort="CategoryText asc" ID="gvPages" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="tablehead"
			...
			<Columns>
				<asp:TemplateField>
					<ItemTemplate>
						<asp:HyperLink runat="server" ID="lnkEdit" NavigateUrl='<%# String.Format("./CategoryAddEdit.aspx?id={0}", Eval("ContentCategoryID")) %>'><img class="imgNoBorder" src="/Manage/images/pencil.png" alt="Edit" title="Edit" /></asp:HyperLink>
					</ItemTemplate>
				</asp:TemplateField>
