<%@ Page Title="TagIndex" Language="C#" MasterPageFile="~/Manage/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="TagIndex.aspx.cs" Inherits="Carrotware.CMS.UI.Admin.Manage.TagIndex" %>
	...
	<div id="SortableGrid">
		<carrot:CarrotGridView CssClass="datatable" DefaultSort="TagText asc" ID="gvPages" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="tablehead"
			...
			<Columns>
				<asp:TemplateField>
					<ItemTemplate>
						<asp:HyperLink runat="server" ID="lnkEdit" NavigateUrl='<%# String.Format("./TagAddEdit.aspx?id={0}", Eval("ContentTagID")) %>'><img class="imgNoBorder" src="/Manage/images/pencil.png" alt="Edit" title="Edit" /></asp:HyperLink>
					</ItemTemplate>
				</asp:TemplateField>
