			...
			if (DisplayAsList) {
				...
				foreach (SiteNav c in lst) {
					...
					if (c.NavFileName.ToLower() == SiteData.CurrentScriptName.ToLower() || c.NavFileName.ToLower() == sParent) {
						output.Write("<li class=\"" + sSelCSS + "\"><a href=\"" + c.NavFileName + "\">" + c.NavMenuText + "</a></li>\r\n");
					} else {
						output.Write("<li" + sWrapCSS + "><a href=\"" + c.NavFileName + "\">" + c.NavMenuText + "</a></li>\r\n");
					}
				}
				output.Write("</ul>");
				...
				foreach (SiteNav c in lst) {
					...
					if (c.NavFileName.ToLower() == SiteData.CurrentScriptName.ToLower() || c.NavFileName.ToLower() == sParent) {
						output.Write("<span class=\"" + sSelCSS + "\"><a href=\"" + c.NavFileName + "\">" + c.NavMenuText + "</a>" + sDivider + "</span> \r\n");
					} else {
						output.Write("<span" + sWrapCSS + "><a href=\"" + c.NavFileName + "\">" + c.NavMenuText + "</a>" + sDivider + "</span> \r\n");
					}
					iCtr++;
