...
namespace Carrotware.CMS.UI.Plugins.CalendarModule
{
    ...
    partial void OnSiteIDChanged();
		...
		[Column(Storage="_CalendarID", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_EventTitle", DbType="VarChar(255)")]
		...
		[Column(Storage="_EventDetail", DbType="VarChar(MAX)")]
