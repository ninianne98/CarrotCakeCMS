<%@ Control Language="C#" AutoEventWireup="true" Codebehind="FAQDisplay.ascx.cs"
    Inherits="Carrotware.CMS.UI.Plugins.FAQModule.FAQDisplay" %>
<asp:DataGrid ID="dgFAQ" runat="server" AutoGenerateColumns="False" GridLines="None"
    CellPadding="2" CellSpacing="0" ShowHeader="False">
    <Columns>
        <asp:TemplateColumn >
